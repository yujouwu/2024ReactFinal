                ...
                <div className="col-lg-6">
                  ...
                  <ul className="list-unstyled border p-5">
                    ...
                    <li className="row mb-3">
                      ...
                      <div className="col-sm-9">
                        <p className={`${orderData.is_paid ? "text-success" : "text-danger"}`}>{orderData.is_paid ? "paid" : "unpaid"}</p>
                      </div>
                    </li>
                  
                  </ul>
                  <button type="button" className={`btn btn-primary-light w-100 mt-6 ${orderData.is_paid ? "disabled" : ""}`} onClick={() => pay(orderData.id)}>{orderData.is_paid ? "Payment Completed" : "Pay now"}</button>
                </div>
                <div className="col-lg-6">
                  <p>Items</p>
                  <div className="border">
